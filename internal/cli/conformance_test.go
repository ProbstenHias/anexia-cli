...
var engineActions = map[string]string{
	...
	"anexia network address create":               "creating address",
	"anexia network address update":               `reading address "placeholder"`,
	"anexia network address delete":               `deleting address "placeholder"`,
	"anexia network address reserve":              "reserving addresses",
...
func TestConformanceLeafAliasesUseKnownVerbs(t *testing.T) {
	...
	allowed := map[string]map[string]bool{
		...
		"anexia network address delete":               {"destroy": true},
